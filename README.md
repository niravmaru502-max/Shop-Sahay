...
2. Deploy on Vercel:
   ...
   - Add any Environment Variables (e.g. `GEMINI_API_KEY`) in the Vercel project settings.
   - Deploy. Vercel will build and publish the site.

This repo includes `vercel.json` to ensure SPA routing and correct `dist` output.
